...
Minden reggel minden különböző $a$ és $b$ buszmegálló pár esetén egy buszjárat indul $a$-ból $b$-be az egyetlen lehetséges útvonalon haladva (minden buszmegállót legfeljebb egyszer érintve). Így tehát $N(N-1)$ buszjárat van. Minden buszjárat mindegyik megállóban megáll a kezdő- és végállomást összekötő útvonalon (beleértve a kezdő- és végállomást is).
