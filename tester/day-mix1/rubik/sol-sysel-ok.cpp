...
int * LISTS[][9]={
	{ROTA,ID,ID,ID,ID,ID,ID,ID,ID},
	{ROTU,ROTA,ROTU,ROTU,ROTU,ID,ID,ID,ID},
	{ROTS,ROTU,ROTA,ROTU,ROTU,ROTU,ROTS,ROTS,ROTS},
	{ROTS,ROTS,ROTU,ROTA,ROTU,ROTU,ROTU,ROTS,ROTS},
	{ROTS,ROTS,ROTS,ROTU,ROTA,ROTU,ROTU,ROTU,ROTS},
	{ROTU,ROTU,ROTA,ROTU,ROTU,ID,ID,ID,ID}
};
